...
use easytidy_protocol::ops::{
    ...
    FsCopy, FsCopyResp, FsMkdir, FsList, FsListResp, FsRead, FsReadResp, FsWrite,
...
#[tauri::command]
async fn import_inspect(paths: Vec<String>) -> Result<ImportInspectResp, String> {
